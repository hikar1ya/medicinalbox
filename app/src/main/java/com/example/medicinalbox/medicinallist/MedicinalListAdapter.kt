    ...
    companion object {
        fun from(parent: ViewGroup): MedicinalListViewHolder {
            ...
            val view = layoutInflater
                .inflate(R.layout.item_medicinal_list, parent, false)
            return MedicinalListViewHolder(view)
        }
    }
}

class MedicinalListAdapter : RecyclerView.Adapter<MedicinalListViewHolder>() {
    ...
    lateinit var viewModel: MedicinalListViewModel
    ...
    override fun onBindViewHolder(holder: MedicinalListViewHolder, position: Int) {
        ...
        holder.editBtn.setOnClickListener {
            viewModel.onEditClicked(item)
        }
        holder.deleteBtn.setOnClickListener {
            viewModel.deleteMedicinal(item)
        }
